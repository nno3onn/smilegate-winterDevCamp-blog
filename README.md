...
* 현업에서는 **이미지를 저장**할 때 어떤 방법 가장 많이 사용되며, 어떤 방법이 가장 효율적인지?
* 전체 **글**을 CRUD하고 관리할 때 지금처럼 필요에 따라 불러오는 방법과 redux(+thunk)를 이용하는 방법 둘 중 어느 것이 더 효율적인지 궁금합니다. 혹은 더 좋은 방법이 있을지?
* 위의 질문과 비슷하게, 글과 관련된 **댓글**을 불러오고 관리할 때 어떤 방법이 현업에서 많이 사용되는지?
* 추가로 공부하면 좋을 주제나 참고하면 좋을 자료는?
* 깃허브 사용 시 기능을 어느 정도 구현했을 때 커밋하는 것이 적당한지?(ㅠㅠ)
